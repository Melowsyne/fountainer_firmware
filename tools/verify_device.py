...
"""verify_device.py — production check after flashing
(serienfertigung.md §22): reads the boot log via USB serial and checks the
        ...
        while time.monotonic() < deadline:
            ...
            if m:
                ...
                for k, want in expected.items():
                    checks[k] = "OK" if got[k] == want else f"FAIL (got {got[k]!r}, expected {want!r})"
