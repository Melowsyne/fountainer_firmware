...
# OTA deployment runs through the dedicated scripts (relative paths,
# local fountainer_server as a sibling checkout):
...
# then reports an old version -> the server offers the same OTA forever.
