...
| [Datapoints.md](Datapoints.md) | The X-macro datapoint engine, report triggers, atomic writes and constraints, complete catalog reference (~100 points with NVS ids). |
