 ...
 * |            |                                    |          | then
 * |            |                                    |          | reboot
 * | WD_MONITOR | completed monitor cycle            |    15 s  | dito
 * | WD_EVENT   | EVT_MONITOR_TICK subscriber (runs  |    30 s  | dito
...
enum {
    ...
    WD_CH_EVENT,
    WD_CH_PUMP,
    WD_CH_CANOPEN,         /* canopen_task cycle; recover = driver restart */          /* critical: 200-ms control cycle */
