...
typedef enum {
    ...
    LOG_MOD_CANOPEN = 9,  /* CANopen slave (canopen_task / co_core)      */
} log_module_id_t;
...
typedef enum {
    ...
    LOG_EVT_CAN_STARTED = 900,        /* args: node_id, kbit/s              */
    LOG_EVT_CAN_STOPPED,              /* args: reason 0=disabled 1=reconfig
                                         2=watchdog recover 3=bus absent    */
    LOG_EVT_CAN_NMT,                  /* args: old state, new state         */
    LOG_EVT_CAN_BUS_OFF,              /* args: bus-off count                */
    LOG_EVT_CAN_RECOVERED,
    LOG_EVT_CAN_SDO_WRITE,            /* args: index, sub, 0=ok/abort code  */
    LOG_EVT_CAN_EMCY,                 /* args: error code, error register   */
    LOG_EVT_CAN_DRIVER_ERROR,         /* args: esp_err, phase               */
    LOG_EVT_CAN_MASTER,               /* args: 1=master active, 0=lost      */
} log_event_id_t;
