...
"""build_device.py — generates the device-specific production artifacts
...
def nvs_sanity_keys(bin_path: Path) -> list:
    """Key NAMES (never values!) from factory.bin — via IDF nvs_tool."""
...
def main():
    ...
    # Check secrets (existence is checked by gen_factory_nvs; here additionally the CN).
