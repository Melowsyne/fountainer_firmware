...
### CANopen slave (config RW NVS ids 601–605; status VOLATILE — [DOKU/CANopen.md](CANopen.md))
...
Over CAN every datapoint is object `0x2000 + i` (catalog order); the EDS in
`canopen/` is regenerated by `tools/gen_canopen_eds.py` on every build.
