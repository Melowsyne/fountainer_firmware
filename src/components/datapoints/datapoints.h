 ...
 *   (v, type, ts, serial, seq, ...). See DATAPOINTS.md for a worked example.
 *
...
/* Like dp_report_full, but WITHOUT resetting the on-change baseline — for
 * local maintenance sessions (firmware_server.md), so the cloud deltas stay
 * intact. */
