 ...
 * pressure_ring.c, Entwurf/drucksensor_datenstruktur.md). Pure C. Checks
 ...
 * 10k stress against a shadow model.
 */
#include <assert.h>
#include <stdio.h>
#include <stdlib.h>
...
static void test_drop_oldest(void)
{
    ...
    /* Partial read in the middle of the ring + max limit */
...
{
    static pressure_sample_t storage[7];   /* small capacity = lots of wrap */
    pressure_ring_t r;
